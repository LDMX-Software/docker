...
export LD_LIBRARY_PATH=${LDMX_BASE}/.container-install/lib:${LD_LIBRARY_PATH}
export PYTHONPATH=${LDMX_BASE}/.container-install/python:${PYTHONPATH}
export PATH=${LDMX_BASE}/.container-install/bin:${PATH}
